...
public class FrmPerfil {
	...
	private void createForm() {
		...
		txtID.setColumns(10);
		txtID.setText(!user.getId().equals("")? user.getId().trim() : "");
		...
		txtUsuario.setText(!user.getNombreUsuario().equals("")? user.getNombreUsuario().trim() : "");
		...
		txtDNI.setText(!user.getDni().equals("")? user.getDni().trim() : "");
		...
		passwordField.setText(!user.getPassword().equals("")? user.getPassword().trim() : "");
		...
		txtNombre.setText(!user.getNombre().equals("")? user.getNombre().trim() : "");
		...
		txtApellido.setText(!user.getApellidos().equals("")? user.getApellidos().trim() : "");
		...
		txtMail.setText(!user.getCorreo().equals("")? user.getCorreo().trim() : "");
		...
		txtAddress.setText(!user.getDireccion().equals("")? user.getDireccion().trim() : "");
